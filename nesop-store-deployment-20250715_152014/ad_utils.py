    ...
    def _create_mock_users(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            'admin': {
                ...
                'memberOf': ['CN=Domain Admins,DC=company,DC=com', 'CN=Administrators,DC=company,DC=com'],
    ...
    def sync_ad_user_to_local(self, username: str, ad_user_info: Dict, balance: int = 0) -> bool:
        ...
        try:
            ...
            if existing_user:
                ...
                # Create new AD user
                is_admin = self.is_user_admin(ad_user_info)
                ...
                logger.info(f"Created new AD user: {username} (admin: {is_admin})")
